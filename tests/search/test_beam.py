...
from vectrify.search import BeamSearchStrategy, ChainState, Result, SearchNode
...
def test_select_parent_picks_randomly_across_beams(strategy):
    ...
    selected_ids = {strategy.select_parent(nodes)[0] for _ in range(100)}
